import _01_sync, _02_async_01_gather, _02_async_02_create_task, _02_async_03_taskgroup, _03_async_call_by_reference, _04_async_gather_with_thread

def main():
    print("===== 동기 =====")
    _01_sync.main()
    print("===== 비동기 - gather =====")
    _02_async_01_gather.main()
